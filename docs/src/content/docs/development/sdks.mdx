...
PHP, C#, Swift (0.18+), JVM languages (0.20+), and Elixir (0.22+). This page is for
...
- **As an embedded extension**: Python ([pyo3](https://pyo3.rs/)), Node.js
  ([napi-rs](https://napi.rs/)), PHP's preferred backend
  ([ext-php-rs](https://github.com/davidcole1340/ext-php-rs)), and Elixir
  (0.22+; [Rustler](https://github.com/rusterlium/rustler)) compile the
...
| Elixir (0.22+) | `secretspec` on Hex (precompiled NIFs) | Distribution workflow pending |
